...
sudo pacman -S --noconfirm --needed mesa vulkan-radeon xf86-video-amdgpu vulkan-intel intel-media-driver lib32-mesa lib32-vulkan-radeon lib32-vulkan-intel rocm-opencl-runtime intel-compute-runtime hip-runtime-amd hiprt

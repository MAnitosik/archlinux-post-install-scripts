...
sudo sed -i '/manitosik=1/c\KERNEL_CMDLINE[default]+=" manitosik=1 zswap.enabled=0 nowatchdog quiet splash amd-pstate=passive rcutree.enable_rcu_lazy=1 cfg80211.ieee80211_regdom=RU mitigations=off amdgpu.ppfeaturemask=0xffffffff"' /etc/default/limine > /dev/null
